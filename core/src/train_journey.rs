...
impl TrainJourney {
    ...
    fn build_synced_return_durations(
        ...
        if forward_route.len() != return_route_len {
            log::warn!(
                "Forward route has {} segments but return route has {} - durations may not sync correctly",
    ...
    fn generate_forward_journeys(
        ...
        while journey_count < MAX_JOURNEYS_PER_LINE {
            ...
            if total_iterations > MAX_ITERATIONS {
                log::warn!(
                    "Forward journey generation for line '{}' exceeded {} iterations, stopping",
    ...
    fn generate_return_journeys(
        ...
        while return_journey_count < MAX_JOURNEYS_PER_LINE {
            ...
            if total_iterations > MAX_ITERATIONS {
                log::warn!(
                    "Return journey generation for line '{}' exceeded {} iterations, stopping",
                    line.code, MAX_ITERATIONS
                );
                break;
            }
